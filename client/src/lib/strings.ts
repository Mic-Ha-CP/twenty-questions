...
const zh: Dict = {
  ...
  ui: {
    ...
    'oracle.assignTo': '指派出题人',
    'seat.vacantMidGame': '出题人位子空着 —— 需要有人接手,这一局才能继续',
    'seat.fill': '我来接手',
    'seat.fillConfirm': '你将立即看到汤底 / 答案词并接手判定。',
    'seat.fillYes': '接手',
...
const en: Dict = {
  ...
  ui: {
    ...
    'oracle.assignTo': 'Assign the oracle seat',
    'seat.vacantMidGame': 'The oracle seat is empty — someone has to take it for this round to continue',
    'seat.fill': 'I will take it',
    'seat.fillConfirm': 'You will see the truth / answer immediately and take over judging.',
    'seat.fillYes': 'Take it',
